...
export function App() {
  ...
  return <div className="app-shell">
    ...
    <header className="site-header">
      <button className="wordmark" onClick={() => setTab('discover')} aria-label="Your Color home"><span className="mark" />CHROMA / 01</button>
    ...
    <div id="main-content">{tab === 'discover' ? <Discover model={model} /> : <You model={model} />}</div>
  </div>
}
